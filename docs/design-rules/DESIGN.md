...
| `LoginTitleBlock`                                  | 双      | 标题 + 副标题                                                                                                  | `title`, `subtitle`, `regionPill?`（桌面兼容）                                        | 标题 y=31 h=38 32 Bold `--login-title-text`；副标题 @(70,75) 540 宽 ≤2 行顶对齐 20 Regular `--login-secondary-text`（2026-07-24 拍板，原 599×23 单行作废）。区域徽标见下方专条                                                                                                                 |
