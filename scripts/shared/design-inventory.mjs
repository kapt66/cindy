...
export function catalogSurfaces() {
  return [
    ...
    {
      id: 'desktop.meka.projects',
      platform: 'desktop',
      title: 'Meka 项目与角色',
      productionEntry:
        'hash `/cc-agent/meka`（MekaProjectRoleEditorRoute：Meka 项目/角色编排、远程实例与创建弹窗）',
      // MekaProjectRoleEditorRoute 复用 features/plugin 的 PluginManagementLayout /
      // PluginManagementPage（activeTab="meka-projects"）作为左侧导航壳，并直接渲染
      // MekaProjectRemoteInstances、MekaProjectCreateDialog——只扫路由文件会漏掉这些样式事实。
      reachableComponents: [
        'MekaProjectRoleEditorRoute',
        'MekaProjectRemoteInstances',
      ...
      styleRoots: [
        ...
        'apps/desktop/src/renderer/features/cc-agent/MekaProjectCreateDialog.tsx',
        'apps/desktop/src/renderer/features/plugin/PluginManagementLayout.tsx',
        'apps/desktop/src/renderer/features/plugin/plugin-motion.css',
      ],
      routerPaths: ['/cc-agent/meka'],
      routeEntryComponents: { '/cc-agent/meka': 'MekaProjectRoleEditorRoute' },
    },
    {
      id: 'desktop.meka.plugins',
      platform: 'desktop',
      title: 'Meka 插件',
      productionEntry: 'hash `/cc-agent/meka/plugins`（GhostPluginPage surface="meka"）',
      // 与 desktop.plugins.installed 同一页面组件，但走 surface="meka" 的 Meka 市场通道；
      // 共享 PluginManagementLayout 与 plugin-motion.css 的样式事实。
      reachableComponents: [
        'GhostPluginPage',
        'GhostPluginDetailView',
        'PluginManagementLayout',
      ...
      routerPaths: ['/cc-agent/meka/plugins'],
      routeEntryComponents: { '/cc-agent/meka/plugins': 'GhostPluginPage' },
    },
    {
      id: 'desktop.meka.skills',
      platform: 'desktop',
      title: 'Meka 技能',
      productionEntry: 'hash `/cc-agent/meka/skills`（MekaSkillHomeView）',
      reachableComponents: [
        'MekaSkillHomeView',
      ...
      styleRoots: [
        'apps/desktop/src/renderer/features/skillhub/MekaSkillHomeView.tsx',
        'apps/desktop/src/renderer/features/skillhub/components/MekaSkillManagementDialog.tsx',
        'apps/desktop/src/renderer/features/skillhub/components/MekaSkillPublishDialog.tsx',
        'apps/desktop/src/renderer/features/skillhub/SkillhubMarketPreviewPanel.tsx',
        'apps/desktop/src/renderer/features/plugin/PluginManagementLayout.tsx',
        'apps/desktop/src/renderer/features/plugin/plugin-motion.css',
      ],
      routerPaths: ['/cc-agent/meka/skills'],
      routeEntryComponents: { '/cc-agent/meka/skills': 'MekaSkillHomeView' },
    },
    {
      id: 'desktop.meka.skills-market',
      platform: 'desktop',
      title: 'Meka 技能市场',
      productionEntry: 'hash `/cc-agent/meka/skills/market`（MekaSkillMarketListView）',
      reachableComponents: [
      ...
      styleRoots: [
        'apps/desktop/src/renderer/features/skillhub/MekaSkillMarketListView.tsx',
        'apps/desktop/src/renderer/features/skillhub/components/MarketCard.tsx',
        'apps/desktop/src/renderer/features/skillhub/components/MekaSkillManagementDialog.tsx',
        'apps/desktop/src/renderer/features/skillhub/SkillhubMarketPreviewPanel.tsx',
      ],
      routerPaths: ['/cc-agent/meka/skills/market'],
      routeEntryComponents: { '/cc-agent/meka/skills/market': 'MekaSkillMarketListView' },
    },
    {
