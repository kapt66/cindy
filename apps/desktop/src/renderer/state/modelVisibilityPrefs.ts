 ...
 * Existing profiles keep their explicit switches; missing routes remain off. Baselines are
 * separate from user overrides so customization and Restore defaults retain their meaning.
 * No remote catalog enters this path.
 *
