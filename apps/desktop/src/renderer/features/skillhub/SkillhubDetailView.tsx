    ...
    >
      ...
      {!editMode && isSkill && detailReady && detailState && (
        <>
          ...
          {!isMekaEntry && isOutdated && publishDetailState?.canManage && entry.registryEntry && (
            <div className="shrink-0 pl-3 pr-3 pt-4">
              <button
                type="button"
                onClick={() => setDiffPanelOpen(true)}
          ...
          {!isMekaEntry && detailState.origin === null && effectivePublishInfo && !effectivePublishInfo.canManage && (
            <div className="shrink-0 pl-3 pr-3 pt-4">
              <div className={cn(
                'flex items-center gap-2.5 rounded-xl px-4 py-3',
                'bg-[var(--settings-btn-secondary-bg)]',
