...
export function CCAgentSessionView({
  ...
  const collabEntry = isMekaCollabSession
    ? {
        eligible: canShowCollabToggleForSession(session),
        skipProjectQuery: false,
      }
