...
function RoutedOrcaWorkerPanel(props: React.ComponentProps<typeof OrcaWorkerPanel>) {
...
export function OrcaWorkersTabBody({
  ...
  useOrcaWorkerAttentionByLeadIds(detachedLeadSessionIds, viewVisible ? ctx.sessionId : undefined);
  ...
  const workerPanelProps = {
    leadSessionId: ctx.sessionId,
    deviceId: ctx.deviceLinkDeviceId ?? undefined,
