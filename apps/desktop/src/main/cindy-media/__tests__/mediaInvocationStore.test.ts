...
describe('saved generation responses', () => {
  it('keeps undownloaded results across pruning without exhausting generation slots', async () => {
    ...
    try {
      // Meka 侧 media_invocations 的建表随上游 0092 并入 0092_sync_upstream_20260821。
      raw.exec(readFileSync(path.resolve(__dirname, '../../../../drizzle/0092_sync_upstream_20260821.sql'), 'utf8'));
